...
namespace FacilitiesFeedback
{
    public partial class frmFeedbackDetail : Form
    {
        ...
        private void AddData()
        {
            ...
            cboxDeviceStatus.Texts = device.Status == 0 ? "Faulty" : feedback.Status == 1 ? "Correcting" : "Normal";
        ...
        private void btnSave_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        Device device = deviceRepository.GetDeviceById(Int32.Parse(txtDeviceId.Texts));
                        device.Status = 1;
